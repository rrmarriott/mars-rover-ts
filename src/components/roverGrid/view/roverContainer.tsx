        ...
        return (
            <div className="RoverContainer">
                <div className="RoverGame">
                    ...
                    <h4>
                        Currently Facing: {RoverDirection[rover.direction]}.
                        Position: X = {rover.xPos}, Y = {rover.yPos}
                    </h4>
                ...
                <div>
                    <ul>
                        ...
                        commands encounters an obstacle, the rover moves up to the last possible point and reports the
                        obstacle.
                        </li>
                    </ul>
                </div>
